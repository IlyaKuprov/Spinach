...
- Lines 53-54: Simulation; implemented by `fid=liquid(subsystem,@hmqc,parameters,'nmr')`.
...
- Lines 34: computes `parameters.decouple_f1` using `parameters.decouple_f1={'1H'}`.
