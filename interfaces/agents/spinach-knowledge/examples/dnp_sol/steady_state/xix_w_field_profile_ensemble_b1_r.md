...
- Lines 13-14: Q-band magnet; implemented by `sys.magnet=3.4`.
...
- Lines 40-41: Microwave resonance offsets, Hz; implemented by `offsets=linspace(-300e6,300e6,201)`.
...
- Lines 83-84: Set electron nutation frequency; implemented by `parameters.irr_powers=b1(k)`.
...
- Lines 41: computes `offsets` using `offsets=linspace(-300e6,300e6,201)`.
