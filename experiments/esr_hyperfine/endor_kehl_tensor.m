...
%
%      [endor_amp,parameters]=endor_kehl_tensor(spin_system,parameters,H,R)
%
% Parameters:
%
...
function [endor_amp,parameters]=endor_kehl_tensor(spin_system,parameters,H,R)

    % Check consistency
    grumble(spin_system,parameters,H,R);

    % Append sequence-specific parameters
    parameters=kehl_tensor_parameters(parameters);
