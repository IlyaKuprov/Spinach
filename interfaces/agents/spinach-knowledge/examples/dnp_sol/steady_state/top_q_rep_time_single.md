...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/steady_state/top_q_rep_time_single.m`
- Signature: `top_q_rep_time_single()`
- Total lines: 101

## Purpose

Simulation of TOP DNP repetition time scan in the steady state. Calculation time: seconds.
...
- Lines 81-83: Set the shot spacing; implemented by `pulses_time=localpar.nloops*(localpar.pulse_dur+ localpar.delay_dur)`.
