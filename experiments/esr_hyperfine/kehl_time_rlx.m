...
function endor_amp=kehl_time_rlx(constants,spinOps,spinSys,expt,opt,paramsENDOR,EPR)
            ...
            v_RF=v_L(1);
                ...
                if opt("Bterm")==false
                    ...
                    if t(5)==t(7)
                        ...
                        U7=kehl_rf_bterm_rlx(opt,expt,v_RF,Hfree_p,Iy,t(7),Ni_ENDOR,N_spinSys,R,spinOps('spin_system'));
                    end
