...
- Lines 42-43: Distance and B1 ensemble; implemented by `[b1,wb1]=gaussleg(25e6,35e6,5)`.
- Lines 45-46: TPPM loop count; implemented by `loop_counts=1:256`.
...
- Lines 74-75: Preallocate equilibrium DNP value array; implemented by `dnp=zeros([numel(loop_counts) numel(b1)],'like',1i)`.
...
- Line 84: `parfor` loop over `m=1:numel(loop_counts)`.
...
- Lines 46: computes `loop_counts` using `loop_counts=1:256`.
