...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_paramag/carb_anh/s220c_point.m`
- Signature: `s220c_point()`
- Total lines: 38

## Purpose

Point fit for the S220C mutant dataset for human carbonic anhydrase II. The system and the method are described in: A step-by-step tutorial is available here:
