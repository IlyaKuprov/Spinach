...
- Lines 10-11: Set WAR9 nitrogen interstitial centre parameters; implemented by `ninter_params.orientation='111'`.
- Lines 15-16: Build the spin system; implemented by `[sys,inter]=diamond_n_inter(ninter_params)`.
...
- Lines 11: computes `ninter_params.orientation` using `ninter_params.orientation='111'`.
- Lines 12: computes `ninter_params.nitrogen` using `ninter_params.nitrogen='15N'`.
- Lines 13: computes `ninter_params.centre` using `ninter_params.centre='war9'`.
- Lines 16: computes `[sys,inter]` using `[sys,inter]=diamond_n_inter(ninter_params)`.
...
- Lines 32: computes `parameters.fwhm` using `parameters.fwhm=1e-5`.
