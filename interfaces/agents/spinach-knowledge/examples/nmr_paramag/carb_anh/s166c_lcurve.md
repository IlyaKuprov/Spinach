...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_paramag/carb_anh/s166c_lcurve.m`
...
- Lines 29: computes `parameters.box_cent` using `parameters.box_cent=[-14.0 -3.6 -11.0]`.
