...
% placed inside the plot box, with its left edge and its
% cap line 10 points away from the left and the top edge
% of the box, whatever the proportions of the figure or
% of the axes. Syntax:
%
...
%       final size and a tiled layout all of its tiles;
%       the label is stored as a fraction of the plot
%       box and follows the axes if they are resized
%       later. The label carries the tag 'kletter', and
%       fig2tiles.m re-applies it to the retiled axes
%       of a merged figure.
%
...
plot_box=tightPosition(ax_obj); ax_obj.Units=ax_units;

% Label position as a fraction of the plot box
label_x=edge_offset/plot_box(3);
label_y=1-edge_offset/plot_box(4);
