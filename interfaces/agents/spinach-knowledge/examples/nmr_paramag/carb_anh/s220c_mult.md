...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_paramag/carb_anh/s220c_mult.m`
...
- Lines 23-24: Solve the inverse problem; implemented by `[mxyz,chi,~,pred_pcs]=ilpcs(xyz,expt_pcs,[0 1 2],[-14 -26 4])`.
...
- Lines 24: computes `[mxyz,chi,~,pred_pcs]` using `[mxyz,chi,~,pred_pcs]=ilpcs(xyz,expt_pcs,[0 1 2],[-14 -26 4])`.
