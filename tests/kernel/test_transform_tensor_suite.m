...
result=test_close(result,'mat2axrh anisotropy',ax_obs,3,1e-15,1e-15,...
                  'mat2axrh reports zz-(xx+yy)/2 for Mehring-ordered eigenvalues');
result=test_close(result,'mat2axrh rhombicity',rh_obs,-2,1e-15,1e-15,...
                  'mat2axrh reports xx-yy for Mehring-ordered eigenvalues');
