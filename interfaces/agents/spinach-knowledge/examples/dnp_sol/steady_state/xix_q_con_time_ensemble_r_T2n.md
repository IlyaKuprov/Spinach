...
- Lines 13-14: Nuclear T2 times, seconds; implemented by `T2n=[2000e-6 200e-6 20e-6 2e-6 0.2e-6]`.
...
- Lines 14: computes `T2n` using `T2n=[2000e-6 200e-6 20e-6 2e-6 0.2e-6]`.
...
- Line 36: `xix_contact_curve_ensemble_r()` — `function xix_contact_curve_ensemble_r(T2n)`. Q-band magnet
