...
%
%      [endor_amp,parameters]=endor_kehl_mims(spin_system,parameters,H,R)
%
% Parameters:
%
...
function [endor_amp,parameters]=endor_kehl_mims(spin_system,parameters,H,R)

    % Check consistency
    grumble(spin_system,parameters,H,R);

    % Append sequence-specific parameters
    parameters=kehl_mims_parameters(parameters);
    ...
    endor_amp=kehl_mims_calc(spin_system,parameters,R);
end
...
function endor_amp=kehl_mims_calc(spin_system,parameters,R)
