...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_metabol/molecule_b.m`
...
- Lines 9-10: Import GISSMO dataset; implemented by `[sys,inter]=gissmo2spinach('molecule_b.xml',1)`.
...
- Lines 10: computes `[sys,inter]` using `[sys,inter]=gissmo2spinach('molecule_b.xml',1)`.
...
- Lines 16: computes `bas.prox_level` using `bas.prox_level=1`.
...
- Lines 27: computes `parameters.offset` using `parameters.offset=3500`.
