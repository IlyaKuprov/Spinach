...
- Lines 32-33: Cooridnates; implemented by `inter.coordinates={[ 0.000 0.000 0.000]`.
...
- Lines 23: computes `inter.zeeman.eigs{1,2}` using `inter.zeeman.eigs{1,2}=[2.003400 2.003800 2.003800]`.
- Lines 24: computes `inter.zeeman.euler{1,2}` using `inter.zeeman.euler{1,2}=[-0.872 -0.013 0.868]`.
- Lines 25: computes `inter.zeeman.eigs{1,3}` using `inter.zeeman.eigs{1,3}=[2.005700 2.003000 2.003000]`.
- Lines 26: computes `inter.zeeman.euler{1,3}` using `inter.zeeman.euler{1,3}=[-1.145 0.061 1.143]`.
- Lines 29: computes `inter.coupling.scalar` using `inter.coupling.scalar=cell(3,3)`.
- Lines 30: computes `inter.coupling.scalar{2,3}` using `inter.coupling.scalar{2,3}=3e6`.
