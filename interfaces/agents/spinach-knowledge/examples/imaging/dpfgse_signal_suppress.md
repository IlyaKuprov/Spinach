...
- Lines 60-61: 180-degree shaped pulse on water; implemented by `pulse_nsteps=10`.
...
- Lines 86-87: Run simulation; implemented by `fid=imaging(spin_system,@dpfgse_suppress,parameters)`.
