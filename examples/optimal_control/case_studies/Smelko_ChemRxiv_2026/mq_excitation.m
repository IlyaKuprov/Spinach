...
% forms supplied in this folder reached fidelities of 0.72 (3Q) and
% 0.65 (5Q) after 500 iterations.
%
% Calculation time: hours on 128 cores.
%
% ilya.kuprov@weizmann.ac.il

function mq_excitation()

% Coherence order to excite, 3 or 5
mq_order=5;
...
% Target state, symmetric MQ coherence between m=+mq_order/2 and m=-mq_order/2
rho_targ=zeros(6); rho_targ(3.5-mq_order/2,3.5+mq_order/2)=1;
rho_targ=rho_targ+rho_targ'; rho_targ=rho_targ/norm(rho_targ,'fro');
