...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/steady_state/xix_q_con_time_single.m`
- Signature: `xix_q_con_time_single()`
- Total lines: 94

## Purpose

Simulation of XiX DNP contact time dependence in the steady state. Calculation time: minutes.
...
- Lines 55-56: XiX loop count; implemented by `loop_counts=1:64`.
