...
prune_args=loaded.mex_calls{6};
knum_args=loaded.mex_calls{7};
...
prune_args_cmp=strrep(strrep(prune_args,'/',filesep),'\',filesep);
knum_args_cmp=strrep(strrep(knum_args,'/',filesep),'\',filesep);
...
prune_out=prune_args_cmp{find(strcmp(prune_args,'-outdir'),1)+1};
knum_out=knum_args_cmp{find(strcmp(knum_args,'-outdir'),1)+1};
result=test_true(result,'compile_mex compiler calls',...
                 numel(loaded.mex_calls)==7&&...
                 ...
                 any(strcmp(prune_args,'-R2018a'))&&...
                 any(strcmp(knum_args,'-R2018a'))&&...
                 ...
                 any(strcmp(prune_args_cmp,fullfile(scratch,'etc','mex','prune_cpu.cpp')))&&...
                 any(strcmp(knum_args_cmp,fullfile(scratch,'etc','mex','knum2cell.cpp')))&&...
                 ...
                 strcmp(prune_out,fullfile(scratch,'etc','mex'))&&...
                 strcmp(knum_out,fullfile(scratch,'etc','mex')),...
                 'compile_mex must compile the seven listed MEX sources into their source directories with the interleaved-complex API');
...
result=test_true(result,'compile_mex source confinement',...
                 ...
                 contains(compile_src,'etc/mex/prune_cpu.cpp')&&...
                 contains(compile_src,'etc/mex/knum2cell.cpp')&&...
                 ...
                 contains(compile_src,'''-outdir'',[P ''/etc/mex'']')&&...
