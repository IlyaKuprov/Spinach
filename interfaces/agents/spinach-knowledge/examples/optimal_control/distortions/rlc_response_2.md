...
- Lines 75-76: Freeze the edges; implemented by `control.freeze=false(2,75)`.
...
- Lines 86-87: Waveform guess with zeros at the edges; implemented by `guess=randn(2,75)/10; guess(:,1:4)=0`.
...
- Lines 97-99: Apply RLC response distortion by a probe circuit with Q = 200; implemented by `kfigure(); restrans(CLx',CLy',control.pulse_dt(1), sys.magnet*spin('2H'),200,'pwc',100)`.
