...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_liquids/hetcor_sucrose.m`
...
- Lines 63-64: Simulation; implemented by `fid=liquid(subsystem,@hetcor,parameters,'nmr')`.
...
- Lines 39: computes `parameters.sweep` using `parameters.sweep=[1000 3350]`.
- Lines 40: computes `parameters.offset` using `parameters.offset=[1200 5000]`.
...
- Lines 43: computes `parameters.spins` using `parameters.spins={'1H','13C'}`.
