...
- Source commit: `merge parents 91e07e18 and 4f791958`
- Source tree state: `merged commit snapshot`
...
- Total source lines: **73333**
- Generated: 2026-09-26T16:09:52.376041+00:00
...
| `kernel/relaxation.m` | `R=relaxation(spin_system,euler_angles)` | Relaxation superoperator. Syntax: R=relaxation(spin_system,euler_angles) Parameters: euler_angles -three Euler angles (Z | 897 |
