...
| `kernel/utilities/sim2liouv.m` | `[spin_system,parameters,H,R,K]=sim2liouv(spin_system,parameters,H,R,K)` | Moves a zeeman-hilb simulation context into Liouville space. When the formalism specified in the spin system object is ' | 193 |
