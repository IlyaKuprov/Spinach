...
fid_f= params(1)*apodisation(spin_system,fid_f, {{'exp',8.0}})/3e2;
fid_ha=params(2)*apodisation(spin_system,fid_ha,{{'exp',9.0}})/3e2;
fid_hb=params(3)*apodisation(spin_system,fid_hb,{{'exp',6}})/3e2;
