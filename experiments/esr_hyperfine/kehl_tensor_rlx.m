...
function endor_amp=kehl_tensor_rlx(constants,spinOps,spinSys,expt,opt,paramsENDOR,EPR)
        ...
        for i=1 : Ni_ENDOR
            ...
            % for a=1   %%% for testing
                ...
                if opt("Bterm")==false
                    ...
                    U1=kehl_rf_bterm_rlx(opt,expt,v_RF,Hfree_p,Iy,t(1),Ni_ENDOR,N_spinSys,R,spinOps('spin_system'));
                    U2=full(propagator(spinOps('spin_system'),1i*sparse(R-1i*Hfree),t2));
                end
