...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/steady_state/tppm_q_rep_time_ensemble_b1.m`
- Signature: `tppm_q_rep_time_ensemble_b1()`
- Total lines: 113

## Purpose

Simulation of TPPM DNP repetition time scan in the steady state with distributions in microwave B1 field. Calculation time: minutes.
...
- Lines 42-43: B1 ensemble; implemented by `[b1,wb1]=gaussleg(25e6,35e6,5)`.
- Lines 45-46: Log spacing for rep. time; implemented by `rep_time=logspace(-5.0,-2.7,30)`.
...
- Lines 43: computes `[b1,wb1]` using `[b1,wb1]=gaussleg(25e6,35e6,5)`.
- Lines 46: computes `rep_time` using `rep_time=logspace(-5.0,-2.7,30)`.
