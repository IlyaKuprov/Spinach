...
- Lines 30: computes `parameters.box_cent` using `parameters.box_cent=[-16.0 -25.5 6.0]`.
- Lines 31: computes `parameters.box_size` using `parameters.box_size=[ 30.0 20.0 25.0]`.
...
- Lines 43: computes `[source_cube,ranges]` using `[source_cube,ranges]=ipcs(parameters,n,0.17)`.
