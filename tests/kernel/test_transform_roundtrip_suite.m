...
result=test_close(result,'mat2axrh axiality',ax_back,2*eigvals(3)-(eigvals(1)+eigvals(2)),1e-14,1e-14,...
                  'mat2axrh axiality is 2*zz-(xx+yy) in Mehring order');
result=test_close(result,'mat2axrh rhombicity',rh_back,eigvals(2)-eigvals(1),1e-14,1e-14,...
                  'mat2axrh rhombicity is yy-xx in Mehring order');
