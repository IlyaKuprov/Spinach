...
- Lines 65-66: DEER pulse parameters; implemented by `parameters.pulse_rnk=[2 2 2 2]`.
- Lines 72-73: DEER echo timing parameters; implemented by `parameters.p1_p2_gap=0.5e-6`.
- Lines 79-80: Simulation and plotting; implemented by `deer_4p_soft_diag(spin_system,parameters)`.
