...
Simulation of T2e dependence of XiX DNP repetition time profile in the steady state with electron-proton distan- ce ensemble. Calculation time: hours
...
- Line 36: `xix_rep_time_ensemble_r()` — `function xix_rep_time_ensemble_r(T2e)`. Q-band magnet
