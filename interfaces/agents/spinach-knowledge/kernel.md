...
- Source tree state: `merged source tree (PR head plus origin/main)`
...
| `kernel/pulses/shaped_pulse_xy.m` | `[rho,traj,P]=shaped_pulse_xy(spin_system,drift,controls,amplitudes,slice_durs,rho,method)` | Shaped pulse function using Cartesian coordinates. Applies a user- specified pulse shape on user-specified operators whi | 422 |
