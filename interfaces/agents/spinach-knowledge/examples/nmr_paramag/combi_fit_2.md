...
- Lines 12-13: Read DFT HFCs in Gauss; implemented by `props=gparse('l2_parker_funk_yb.log')`.
...
- Lines 32-33: Paramagnetic shifts; implemented by `parameters.p_shifts=[3.8 -13.7 -0.6 -3.4 5.2 20.7 10.7 10.3 10.7]`.
- Lines 35-36: Paramagnetic shift ambiguities; implemented by `parameters.p_ambig={[3 4]}`.
...
- Lines 13: computes `props` using `props=gparse('l2_parker_funk_yb.log')`.
...
- Lines 33: computes `parameters.p_shifts` using `parameters.p_shifts=[3.8 -13.7 -0.6 -3.4 5.2 20.7 10.7 10.3 10.7]`.
- Lines 36: computes `parameters.p_ambig` using `parameters.p_ambig={[3 4]}`.
