...
- Lines 9-10: Import GISSMO dataset; implemented by `[sys,inter]=gissmo2spinach('molecule_a.xml',1)`.
...
- Lines 10: computes `[sys,inter]` using `[sys,inter]=gissmo2spinach('molecule_a.xml',1)`.
...
- Lines 28: computes `parameters.sweep` using `parameters.sweep=3000`.
