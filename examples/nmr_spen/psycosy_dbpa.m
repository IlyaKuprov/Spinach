...
% Interactions
inter.zeeman.scalar={4.49 3.9 3.7 4.2};
inter.coupling.scalar{1,2}=11.3; 
inter.coupling.scalar{2,3}=10.1;  
inter.coupling.scalar{1,3}=4.3; 
inter.coupling.scalar{4,2}=0;
