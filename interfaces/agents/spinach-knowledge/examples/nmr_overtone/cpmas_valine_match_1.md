...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_overtone/cpmas_valine_match_1.m`
...
- Lines 66-67: Proton RF power array; implemented by `rf_powers=linspace(26e3,40e3,15)`.
- Lines 69-70: Start a new figure; implemented by `kfigure(); scale_figure([2.5 1.0])`.
- Lines 72-73: Proton RF power scan; implemented by `for n=1:15`.
- Lines 75-76: Subplot selection; implemented by `subplot(1,15,n)`.
- Lines 78-79: Power setting; implemented by `parameters.rf_pwr=2*pi*[55e3 rf_powers(n)]/sin(theta)`.
...
- Lines 31: computes `inter.damp_rate` using `inter.damp_rate=2000`.
