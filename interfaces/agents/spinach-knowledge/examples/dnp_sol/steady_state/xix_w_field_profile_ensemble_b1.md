...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/steady_state/xix_w_field_profile_ensemble_b1.m`
...
- Lines 71-72: Preallocate equilibrium DNP value array; implemented by `dnp=zeros([numel(parameters.el_offs) numel(b1)],'like',1i)`.
...
- Lines 80-81: Run the steady state simulation; implemented by `dnp(:,k)=powder(spin_system,@xixdnp_steady,parameters,'esr')`.
