...
function top_q_rep_time_ensemble_b1()
...
for k=1:numel(b1)
    ...
    parfor m=1:numel(rep_time)
        ...
        dnp(m,k)=powder(spin_system,@topdnp_steady,localpar,'esr');
...
% Save for later
savefig(gcf,'top_q_rep_time_ensemble_b1.fig');
save('top_q_rep_time_ensemble_b1.mat');
