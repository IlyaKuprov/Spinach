...
- Lines 13-16: Read the spin system (coordinates, chemical shifts, J-couplings and CSAs) from a vacuum DFT calculation; implemented by `[sys,inter]=g2spinach(gparse('../standard_systems/benzoquinone.log'), {{'H','1H'}},31.8,[])`.
...
- Lines 15-16: computes `[sys,inter]` using `[sys,inter]=g2spinach(gparse('../standard_systems/benzoquinone.log'), {{'H','1H'}},31.8,[])`.
