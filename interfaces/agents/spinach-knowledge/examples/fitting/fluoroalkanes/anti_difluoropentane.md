...
- Lines 14-15: Load experimental data; implemented by `load('anti_dfp_fluorine.mat','axis_ppm','spec'); axis_expt_f =axis_ppm; spec_expt_f =spec`.
- Lines 19-20: Normalise the data; implemented by `spec_expt_f= 7*spec_expt_f/max(spec_expt_f)`.
- Lines 24-26: Set the guess; implemented by `guess=[ 6.2155 23.8923 9.8426 2.4324 13.7379 36.4223 49.2708 1.6130 -15.1165 1.0605 0.7229 1.4874]`.
...
- Lines 15: computes `load('anti_dfp_fluorine.mat','axis_ppm','spec'); axis_expt_f` using `load('anti_dfp_fluorine.mat','axis_ppm','spec'); axis_expt_f =axis_ppm; spec_expt_f =spec`.
- Lines 20: computes `spec_expt_f` using `spec_expt_f= 7*spec_expt_f/max(spec_expt_f)`.
- Lines 21: computes `spec_expt_ha` using `spec_expt_ha=4*spec_expt_ha/max(spec_expt_ha)`.
- Lines 22: computes `spec_expt_hb` using `spec_expt_hb=10*spec_expt_hb/max(spec_expt_hb)`.
- Lines 25-26: computes `guess` using `guess=[ 6.2155 23.8923 9.8426 2.4324 13.7379 36.4223 49.2708 1.6130 -15.1165 1.0605 0.7229 1.4874]`.
