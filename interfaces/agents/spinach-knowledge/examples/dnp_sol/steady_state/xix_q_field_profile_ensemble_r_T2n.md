...
Simulation of T2n dependence of XiX DNP field profiles in the steady state with electron- proton distance ensemble. Calculation time: minutes
...
- Line 36: `xix_field_profile_ensemble_r()` — `function xix_field_profile_ensemble_r(T2n)`. Q-band magnet
