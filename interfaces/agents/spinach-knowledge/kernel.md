...
| `kernel/utilities/kill_spin.m` | `spin_system=kill_spin(spin_system,hit_list)` | Removes the specified spins from the spin_system structure and updates it accordingly. Syntax: spin_system=kill_spin(spi | 227 |
