...
| `kernel/utilities/kill_spin.m` | `spin_system=kill_spin(spin_system,hit_list)` | Removes specified particles (spins or bosonic modes) and invalidates dependent metadata. | 236 |
