...
ext=[ext(1)-npts(1)*dx*pad_factor ext(2)+npts(1)*dx*pad_factor...
     ext(3)-npts(2)*dy*pad_factor ext(4)+npts(2)*dy*pad_factor...
     ext(5)-npts(3)*dz*pad_factor ext(6)+npts(3)*dz*pad_factor];
