...
- Lines 44: computes `parameters.offset` using `parameters.offset=[(-13.0+59.5)*1e6 0]`.
- Lines 45: computes `parameters.irr_powers` using `parameters.irr_powers=17.8e6`.
- Lines 46: computes `parameters.pulse_dur` using `parameters.pulse_dur=48e-9`.
- Lines 47: computes `parameters.nloops` using `parameters.nloops=80`.
- Lines 48: computes `parameters.phase` using `parameters.phase=pi`.
- Lines 49: computes `parameters.grid` using `parameters.grid='rep_2ang_1600pts_sph'`.
