...
line_out=line_args{find(strcmp(line_args,'-outdir'),1)+1};
cubic_out=cubic_args{find(strcmp(cubic_args,'-outdir'),1)+1};
result=test_true(result,'compile_mex compiler calls',...
                 ...
                 any(strcmp(line_args,fullfile(scratch,'kernel','line_shapes','lorentzcon.cpp')))&&...
                 any(strcmp(cubic_args,fullfile(scratch,'kernel','eigenfields','cubic_roots.cpp')))&&...
