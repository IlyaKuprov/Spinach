...
function endor_amp=kehl_cp_calc(constants,spinOps,spinSys,expt,opt,paramsENDOR,EPR)
        ...
        for i=1 : size(offsets,2)
            ...
            % for a=1   %%% for testing
                ...
                if opt("Bterm")==false
                    ...
                    U3=kehl_cp_bterm(opt,expt,v_RF,HSL_p,Ix,t(3),Ni_ENDOR,N_spinSys,spinOps('spin_system'));
