...
[X,Y,Z]=ndgrid(ranges(1)+extents(1)*(0:(size(pcs_cube,1)-1))/size(pcs_cube,1),...
               ranges(3)+extents(2)*(0:(size(pcs_cube,2)-1))/size(pcs_cube,2),...
               ranges(5)+extents(3)*(0:(size(pcs_cube,3)-1))/size(pcs_cube,3));
