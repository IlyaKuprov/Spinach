...
%
% <https://spindynamics.org/wiki/index.php?title=chirp_pulse_xy.m>

function varargout=chirp_pulse_xy(varargin) %#ok<STOUT>

% Direct the user to the new function
error('This function is deprecated, use chirp_pulse() instead.');
