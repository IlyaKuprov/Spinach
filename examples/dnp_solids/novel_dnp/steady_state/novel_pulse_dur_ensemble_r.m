% 2D parameter scan of NOVEL DNP in the steady state with 
...
function novel_pulse_dur_ensemble_r()
...
pulse_durs=linspace(300e-9,700e-9,200);
...
for n=1:numel(r)
    ...
    for m=1:numel(pulse_durs)
        ...
        dnp(:,m,n)=powder(spin_system,@noveldnp_steady,parameters,'esr');
