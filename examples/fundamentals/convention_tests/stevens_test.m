...
% Differences, rank 6
diffs=[norm(O_6_p6_Spinach-O_6_p6_Stevens,1) norm(O_6_p5_Spinach-O_6_p5_Stevens,1) ...
...
if norm(diffs)>1e-4, error('Stevens operator test FAILED.'); end
...
% Differences, rank 4
diffs=[norm(O_4_p4_Spinach-O_4_p4_Stevens,1) norm(O_4_p3_Spinach-O_4_p3_Stevens,1) ...
...
if norm(diffs)>1e-7, error('Stevens operator test FAILED.'); end
...
% Differences, rank 2
diffs=[norm(O_2_p2_Spinach-O_2_p2_Stevens,1) norm(O_2_p1_Spinach-O_2_p1_Stevens,1) ...
       norm(O_2_0_Spinach-O_2_0_Stevens,1) ...
       norm(O_2_m1_Spinach-O_2_m1_Stevens,1) norm(O_2_m2_Spinach-O_2_m2_Stevens,1)];
if norm(diffs)>1e-12, error('Stevens operator test FAILED.'); end
...
% Differences, rank 2
diffs=[norm(O_2_p2_Spinach-O_2_p2_IST,1) norm(O_2_p1_Spinach-O_2_p1_IST,1) ...
       norm(O_2_0_Spinach-O_2_0_IST,1) ...
       norm(O_2_m1_Spinach-O_2_m1_IST,1) norm(O_2_m2_Spinach-O_2_m2_IST,1)];
if norm(diffs)>1e-10, error('Stevens operator test FAILED.'); end

% Report that the test is passed
disp('Stevens operator test PASSED.');
