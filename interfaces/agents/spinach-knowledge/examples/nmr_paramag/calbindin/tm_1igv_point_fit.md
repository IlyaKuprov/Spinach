...
- Lines 14-15: Solve the inverse problem; implemented by `[mxyz,chi,pred_pcs]=ippcs([x y z],[-5 5 -15],expt_pcs)`.
...
- Lines 15: computes `[mxyz,chi,pred_pcs]` using `[mxyz,chi,pred_pcs]=ippcs([x y z],[-5 5 -15],expt_pcs)`.
