...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/fundamentals/clebsch_gordan/cg_test_large.m`
...
- Lines 8-9: Load the test file; implemented by `load('cg_test_table_large.mat','cg_test_table')`.
