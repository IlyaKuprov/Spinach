...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_spen/psycosy_acrolein.m`
...
- Lines 15-16: Interactions; implemented by `inter.zeeman.scalar={9.11 5.91 5.49 5.32 7.32}`.
...
- Lines 59-60: Sequence parameters; implemented by `parameters.offset=4392`.
...
- Lines 16: computes `inter.zeeman.scalar` using `inter.zeeman.scalar={9.11 5.91 5.49 5.32 7.32}`.
- Lines 17: computes `inter.coupling.scalar{1,2}` using `inter.coupling.scalar{1,2}=7.7`.
- Lines 18: computes `inter.coupling.scalar{2,3}` using `inter.coupling.scalar{2,3}=10.0`.
- Lines 19: computes `inter.coupling.scalar{2,4}` using `inter.coupling.scalar{2,4}=17.3`.
- Lines 20: computes `inter.coupling.scalar{1,3}` using `inter.coupling.scalar{1,3}=1.0`.
- Lines 21: computes `inter.coupling.scalar{1,4}` using `inter.coupling.scalar{1,4}=1.0`.
