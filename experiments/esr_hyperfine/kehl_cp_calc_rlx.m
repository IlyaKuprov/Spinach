...
function endor_amp=kehl_cp_calc_rlx(constants,spinOps,spinSys,expt,opt,paramsENDOR,EPR)
    ...
    for j=1:length(B_sel)
        ...
        for i=1 : size(offsets,2)
            ...
            if spinSys('N_SpinSys')>1
                ...
                if opt("powder")==false
                    [v_CP,paramsENDOR]=kehl_cp_offset(opt,paramsENDOR,expt,spinSys,v_off_S,HF_zz,NQI_zz,mn,i);
                end
                ...
                for mm=1:Ni_ENDOR
                    ...
                    % get offset for sc CP calculation
                    if opt("powder")==false
                        [v_CP,paramsENDOR]=kehl_cp_offset(opt,paramsENDOR,expt,spinSys,v_off_S,HF_zz,NQI_zz,mm,i);
                    end
                end
            ...
            % for a=1   %%% for testing
                ...
                Hfree=full(hilb2liouv(sparse(Hfree),'comm'));
                    ...
                    if opt("Bterm")==false
                        ...
                        U3=kehl_cp_bterm_rlx(opt,expt,v_CP,HSL_t,Ix,t(3),Ni_ENDOR,N_spinSys,RRho,spinOps('spin_system'));
