...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/solid_effect_freq_scan_2.m`
...
- Lines 70-71: Steady state simulation; implemented by `answer=powder(spin_system,@dnp_freq_scan,parameters,'esr')`.
...
- Called routines detected from the main body: `create()`, `basis()`, `state()`, `operator()`, `powder()`, `kfigure()`, `scale_figure()`, `subplot()`, `answer()`, `kxlabel()`, `kylabel()`.
