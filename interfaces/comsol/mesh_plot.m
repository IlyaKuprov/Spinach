...
patch(spin_system.mesh.plot.edg_a,...
      ...
      spin_system.mesh.plot.edg_c,...
      0,'EdgeColor','black','EdgeAlpha',0.2,'FaceAlpha',0.0);
...
patch(spin_system.mesh.plot.vor_a,...
      ...
      0,'EdgeColor','blue','EdgeAlpha',0.2,'FaceAlpha',0.0);
...
if abs(qscale)>0
    quiver(spin_system.mesh.x,spin_system.mesh.y,...
           spin_system.mesh.u,spin_system.mesh.v,qscale);
end
