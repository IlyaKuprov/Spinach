# examples/optimal_control/steady_orbit/solid_effect_xix.m

- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/optimal_control/steady_orbit/solid_effect_xix.m`
...
- Line 121: `for` loop over `n=1:numel(altern)`.
...
- Called routines detected from the main body: `r1n_dnp()`, `create()`, `basis()`, `operator()`, `hamiltonian()`, `assume()`, `equilibrium()`, `state()`, `spin()`, `drifts()`, `false()`, `true()`, `load()`, `firf()`, `optimcon()`, `altern()`.
