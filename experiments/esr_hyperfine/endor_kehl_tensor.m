%ENDOR_KEHL_TENSOR Full-tensor ENDOR experiment for the SimDyn ENDOR context.
...
if parameters.opt('Relax')==true
    endor_amp=kehl_tensor_rlx(parameters.constants,parameters.spinOps,...
                                          parameters.spinSys,parameters.expt,parameters.opt,...
                                          parameters.paramsENDOR,parameters.epr);
else
    endor_amp=kehl_tensor_calc(parameters.constants,parameters.spinOps,...
                                    parameters.spinSys,parameters.expt,parameters.opt,...
                                    parameters.paramsENDOR,parameters.epr);
end
end
