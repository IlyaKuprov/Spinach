...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/top_dnp/top_parameter_scan.m`
...
- Lines 45: computes `parameters.pulse_dur` using `parameters.pulse_dur=10e-9`.
- Lines 46: computes `parameters.delay_dur` using `parameters.delay_dur=14e-9`.
- Lines 47: computes `parameters.nloops` using `parameters.nloops=300`.
