...
% for a single transmon, based on: 
%
...
nsteps=224; t_g=112e-3;
t=linspace(0, t_g, nsteps);
Fa=[-0.6137 -0.0247 0.0742 0.0507 0.0149];
Fb=[-0.0106 0.0334 0.0579 0.0140 -0.0416];
omega_x=zeros(1,nsteps);
omega_y=zeros(1,nsteps);
for n=1:length(Fa)
...
control.pwr_levels=2*pi*[15 16 17 18 19];         % Pulse power ensemble 
