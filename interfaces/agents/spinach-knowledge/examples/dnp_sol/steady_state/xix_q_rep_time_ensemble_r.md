...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/dnp_sol/steady_state/xix_q_rep_time_ensemble_r.m`
- Signature: `xix_q_rep_time_ensemble_r()`
- Total lines: 108

## Purpose

Simulation of XiX DNP repetition time scan in the steady state with distributions in electron-proton distance. Calculation time: minutes.
...
- Lines 38-39: Log spacing for rep. time; implemented by `rep_time=logspace(-5,-3,30)`.
...
- Lines 39: computes `rep_time` using `rep_time=logspace(-5,-3,30)`.
