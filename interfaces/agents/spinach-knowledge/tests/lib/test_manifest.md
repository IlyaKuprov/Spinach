...
Each entry stores a stable test ID, a descriptive name, and the function name to run. The cooperative-gradient, rotor-assumption, and SRSK-form tests are registered. This catalogue does not execute the tests.
