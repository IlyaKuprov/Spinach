...
| `examples/quantum_tech/geometric_phase_gate.m` | `geometric_phase_gate()` | Geometric phase gate between two trapped-ion qubits driven by a state-dependent optical dipole force, as demonstrated by Le | 141 |
