...
function endor_amp=kehl_time_calc(constants,spinOps,spinSys,expt,opt,paramsENDOR,EPR)
            ...
            if spinSys('N_SpinSys')>1
                ...
                if opt('Bterm')==false
                    ...
                    if t(5)==t(7)
                        ...
                        U7=kehl_rf_bterm(opt,expt,v_RF,Hfree,Iy,t(7),Ni_ENDOR,N_spinSys,spinOps('spin_system'));
                    end
                end
