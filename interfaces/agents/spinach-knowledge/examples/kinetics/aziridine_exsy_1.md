...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/kinetics/aziridine_exsy_1.m`
...
- Lines 126-127: Chemical kinetics; implemented by `kplus=4; kminus=20`.
- Lines 134-135: Relaxation theory; implemented by `inter.relaxation={'redfield','SRSK'}`.
- Lines 141-142: Basis set; implemented by `bas.formalism='sphten-liouv'`.
- Lines 148-149: Algorithmic options; implemented by `sys.disable={'krylov'}`.
- Lines 152-153: Proximity cut-off; implemented by `sys.tols.prox_cutoff=10.0`.
- Lines 155-156: Spinach housekeeping; implemented by `spin_system=create(sys,inter)`.
- Lines 159-160: Sequence parameters; implemented by `parameters.offset=2000`.
- Lines 168-169: Concentration-aware initial state; implemented by `parameters.rho0=state(spin_system,'Lz','1H','chem')`.
- Lines 171-172: Simulation; implemented by `fid=liquid(spin_system,@noesy,parameters,'nmr')`.
- Lines 174-175: Apodisation; implemented by `fid.cos=apodisation(spin_system,fid.cos,{{'sqcos'},{'sqcos'}})`.
- Lines 178-179: F2 Fourier transform; implemented by `f1_cos=real(fftshift(fft(fid.cos,parameters.zerofill(2),1),1))`.
