...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/nmr_paramag/carb_anh/s166c_point.m`
- Signature: `s166c_point()`
- Total lines: 38

## Purpose

Point fit for the S166C mutant dataset for human carbonic anhydrase II. The system and the method are described in: A step-by-step tutorial is available here:
...
- Lines 23-24: Solve the inverse problem; implemented by `[mxyz,chi,pred_pcs]=ippcs(xyz,[-15.0 -3.0 -10.0],expt_pcs)`.
...
- Lines 24: computes `[mxyz,chi,pred_pcs]` using `[mxyz,chi,pred_pcs]=ippcs(xyz,[-15.0 -3.0 -10.0],expt_pcs)`.

## Implementation structure

- Point fit for the S166C mutant dataset for human carbonic anhydrase
