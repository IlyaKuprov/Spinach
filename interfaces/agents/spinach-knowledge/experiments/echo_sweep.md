...
- Lines 146-147: Select the -1 coherence on the electron; implemented by `rho=coherence(spin_system,rho,{{parameters.spins{1},-1}})`.
...
- Lines 159-160: Select the +1 coherence on the electron; implemented by `rho=coherence(spin_system,rho,{{parameters.spins{1},+1}})`.
