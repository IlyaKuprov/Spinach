...
- Source: `/home/kuprov/.openclaw/workspace/Spinach/examples/esr_sol_pulsed/soft_3_pulse_deer_2e.m`
- Signature: `soft_3_pulse_deer_2e()`
- Total lines: 79

## Purpose

Three-pulse DEER simulation for a two-electron system. Soft pulses are simulated using the Fokker-Planck formalism. Calculation time: minutes
...
- Lines 62-63: DEER pulse parameters; implemented by `parameters.pulse_rnk=[2 2 2]`.
- Lines 69-70: DEER echo timing parameters; implemented by `parameters.p1_p3_gap=1e-6`.
- Lines 75-76: Simulation and plotting; implemented by `deer_3p_soft_diag(spin_system,parameters)`.
