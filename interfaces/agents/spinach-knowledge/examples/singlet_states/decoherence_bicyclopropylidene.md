...
- Lines 13-16: Read the spin system (coordinates, chemical shifts, J-couplings and CSAs) from a vacuum DFT calculation; implemented by `[sys,inter]=g2spinach(gparse('../standard_systems/bicyclopropylidene.log'), {{'H','1H'}},31.8,[])`.
...
- Lines 44-45: List twenty smallest magnitude eigenvalues; implemented by `disp('Twenty smallest relaxation rates, Hz:')`.

### Key state/data transformations

- Lines 15-16: computes `[sys,inter]` using `[sys,inter]=g2spinach(gparse('../standard_systems/bicyclopropylidene.log'), {{'H','1H'}},31.8,[])`.
