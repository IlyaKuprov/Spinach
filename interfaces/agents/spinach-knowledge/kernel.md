...
| `kernel/utilities/remncomm.m` | `A=remncomm(A,EvB,evals_b)` | Removes from the Hermitian operator A the part that does not com- mute with the Hermitian operator B. Syntax: C=remncomm | 73 |
