...
| `kernel/utilities/rlx_phonon.m` | `R=rlx_phonon(spin_system,H,X,I0,alpha,T)` | Spin-phonon relaxation superoperator in the generalised Lindblad form of Saito, Miyashita, and De Raedt (Phys. Rev. B 60 | 108 |
