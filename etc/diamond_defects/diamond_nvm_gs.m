% NV- center ground state spin system for diamond. Syntax:
%
...
% in the strong spin-phonon coupling regime. 14N isotope is assumed, 
%
% Parameters:
%
...
a_hfc=diag([-2.70 -2.70 -2.14])*1e6;

% Define nuclear quadrupole tensor.
p_nqr=-5.01e6;
nqr_mat=diag([-p_nqr/3 -p_nqr/3 2*p_nqr/3]);
...
nqr_mat=rot_mat*nqr_mat*rot_mat';
...
inter.coupling.matrix{2,2}=nqr_mat;
